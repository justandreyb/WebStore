...
public class SearchByNameService extends SearchServiceImpl {

    @Override
    public List<Product> getProducts(String request) throws ServiceException {
        try {
            List<Product> products = productDAO.searchProduct(request);
            ...
            throw new ServiceException("Error while search products by name", e);
        }
    }
}
