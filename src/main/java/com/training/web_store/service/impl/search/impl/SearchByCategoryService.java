...
public class SearchByCategoryService extends SearchServiceImpl {

    @Override
    public List<Product> getProducts(String request) throws ServiceException {
        try {
            List<Product> products = productDAO.searchProductByCategory(request);
            ...
            throw new ServiceException("Error while search products by category", e);
        }
    }
}
