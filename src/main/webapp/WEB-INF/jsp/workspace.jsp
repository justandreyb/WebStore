...
<div class="site-wrapper">
    <div class="site-wrapper-inner">
        ...
        <div title="navigation-bar" class="masthead clearfix navigation-bar">
            <h3 class="masthead-brand">Cover</h3>
            <nav>
                <ul class="nav masthead-nav">
                    <li class="active"><a href="#">Home</a></li>
                    <li><a href="#">Contact</a></li>
                    <li><a id="account-button" href="#">Sign up</a></li>
                </ul>
            </nav>
        </div>

        <div title="inner-block" class="cover-container">
        ...
        <div title="footer" class="cover-container">
            <div class="footer">
                <div class="inner">
                    <p>
