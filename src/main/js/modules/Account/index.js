...
function* createAccount(action) {
  yield sendElement("/accounts", action.payload, createAccountSuccess, createAccountFail);
}

function* getAccount(action) {
  yield getElement("/accounts", action.payload, getAccountSuccess, getAccountFail);
}

function* updateAccount(action) {
  yield updateElement("/accounts", action.payload.id, action.payload, updateAccountSuccess, updateAccountFail);
}

function* deleteAccount(action) {
  yield deleteElement("/accounts", action.payload, deleteAccountSuccess, deleteAccountFail);
}
